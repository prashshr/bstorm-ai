...
async def get_retrieved_context(user_prompt: str) -> Optional[str]:
    ...
    try:
        ...
        context = (
            ...
            "IMPORTANT — Start your response with EXACTLY ONE LINE stating your data sources "
            "using this format (choose the applicable options):\n"
            "RAG data: [Used/Not Used] | "
            "Self Websearch: [Used/Not Available/Not Needed] | "
            "Training Data: [Used/Not Used]\n"
            "Example: RAG data: Used | Self Websearch: Not Available | Training Data: Used\n"
            "After this single status line, proceed directly to answering the question. "
            "Do not elaborate on the status line. Do not state that you cannot verify data "
            "— if you used RAG data, it is already verified by the search.\n\n"
            f"Sources:\n{sources}\n\n"
            f"Content:\n{extracted_content}"
        )
